  ...
  return (
    ...
    >
      <BottomNavigationAction
        ...
        sx={{ color: location.pathname === "/send" ? "#FF7358" : "#16181C" }}
        icon={<SendIcon size={24} />}
      />
      <BottomNavigationAction
        className={styles["font"]}
        label="Future"
        sx={{ color: location.pathname === "/future" ? "#FF7358" : "#16181C" }}
      ...
      <BottomNavigationAction
        className={styles["font"]}
        label="Balance"
        sx={{ color: location.pathname === "/wallet" ? "#FF7358" : "#16181C" }}
    ...
    >
      <g clipPath="url(#clip0_1165_7687)">
        <path
          ...
          fill={location.pathname === "/send" ? "#FF7358" : "#91919D"}
        />
      </g>
      <defs>
    ...
    >
      <g clipPath="url(#clip0_1165_7693)">
        <path
          ...
          fill={location.pathname === "/future" ? "#FF7358" : "#91919D"}
        />
      </g>
      <defs>
    ...
    >
      ...
      <g clipPath="url(#clip0_1165_7699)">
        <path
          ...
          fill={location.pathname === "/wallet" ? "#FF7358" : "#91919D"}
        />
      </g>
      <defs>
