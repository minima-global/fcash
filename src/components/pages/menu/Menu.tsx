...
const Menu = () => {
  const { setDisplayMenu, displayMenu, tip} =
  ...
  return (
    <>
      <AnimatedDialog
        display={displayMenu}
        dismiss={() => setDisplayMenu(false)}
      >
        <div className="z-[44] absolute left-0 top-0 right-0 bottom-0 md:flex md:items-center md:justify-center">
          <div className="px-8 py-4 flex flex-col bg-neutral-800 absolute bottom-[64px] left-0 right-0 md:relative md:w-[560px] md:rounded-lg">
            <div className="flex justify-between items-center gap-1 text-neutral-100 mb-4">
              <h1 className="tracking-wide text-lg font-bold">Menu</h1>
              <span>
                <svg
            ...
            <ul className="text-neutral-100 space-y-2">
              <li
                className="grid grid-cols-[29px_1fr] items-center gap-2 bg-[#1B1B1B] p-4 hover:bg-black  hover:cursor-pointer hover:text-neutral-200"
                onClick={() => handleNavigation("/dashboard/instructions#send")}
              >
                ...
                <p className="font-bold tracking-widest">Instructions</p>
              </li>
              <li
                className="grid grid-cols-[29px_1fr] items-center gap-2 bg-[#1B1B1B] p-4 hover:bg-black hover:cursor-pointer hover:text-neutral-200"
              ...
              >
                <span className="text-neutral-100">
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clipPath="url(#clip0_2231_58645)">
                      <path
                ...
                <p className="font-bold tracking-widest">Balance</p>
              </li>
              <li
                className="grid grid-cols-[29px_1fr] items-center gap-2 bg-[#1B1B1B] p-4 hover:bg-black hover:cursor-pointer hover:text-neutral-200"
                onClick={() => handleNavigation("/dashboard/smartcontract")}
              >
                <span className="text-neutral-100">
                  <svg
                    width="29"
                ...
                <p className="font-bold tracking-widest">Smart contract</p>
              </li>
              <li
                className="grid grid-cols-[29px_1fr] items-center gap-2 bg-[#1B1B1B] p-4 hover:bg-black hover:cursor-pointer hover:text-neutral-200"
                // onClick={() => {
              ...
              >
                ...
                <p className="font-bold tracking-widest">Block Height: <span className="font-bold text-neutral-300 tracking-widest">{tip}</span> </p>
              </li>
            </ul>
          </div>
        </div>
